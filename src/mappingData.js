...
export const projectMap = [
    {
        ...
        desc: "Designed, created, and deployed a responsive portfolio site for a drone photography company. The site was created using React, CSS, React Router, a third party package to handle lazy loading images, and EmailJS (a third party service to handle contacting the company via email). Users are able to see a custom made carousel on the home page, the gallery with lazy loaded images on the Gallery page, and the contact form along with social icons and links on the contact page."
    },
    {
    ...
    },
    {
        ...
        image: "wordle",
        name: "Wordle Clone",
        desc: "Created a responsive clone of the popular Wordle game using React. The game makes use of the latest version of React with the use of hooks to manage state and third party libraries such as AppContext to pass states between the components and SweetAlerts to provide visually pleasing alerts for the user."
    },
]